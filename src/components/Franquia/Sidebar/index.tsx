...
export default function SidebarFranchise() {
  return (
    <Container>
      <div>
        <nav className="navbar">
          <ul className="navbar-nav">
            ...
            <Link href="/franquia/consultores">
              <li className="nav-item">
                <p className="nav-link">
                  <svg
                    version="1.1"
